// ingest/crawlers/platforms/entertainment/douban.js
...
export class DoubanCrawler extends BaseCrawler {
  ...
  async fetch(options = {}) {
    ...
    try {
      const feed = await rss.parseURL('https://rsshub.rssforever.com/douban/movie/weekly');
...
// 导出实例
export const douban = new DoubanCrawler();
