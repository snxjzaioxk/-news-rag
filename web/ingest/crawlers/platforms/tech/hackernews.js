// ingest/crawlers/platforms/tech/hackernews.js
...
export class HackernewsCrawler extends BaseCrawler {
  ...
  async fetch(options = {}) {
    const cacheKey = `hackernews:best`;
    ...
    try {
      const feed = await rss.parseURL('https://rsshub.rssforever.com/hackernews/best');
...
// 导出实例
export const hackernews = new HackernewsCrawler();
